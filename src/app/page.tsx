...
export default function Home() {
  ...
  return (
    <>
        ...
        <section>
          <div className="flex max-w-[1070px] mx-auto">
            <div className="w-1/2 px-6 md:px-12">
              <h1 className="md:text-[40px] font-bold text-[#032b41] mb-6 text-[24px]">
      ...
      hover:bg-[#20ba68]
        ...
        disabled:cursor-not-allowed disabled:opacity-65"
            ...
            <figure className="flex w-1/2 justify-end">
              <img
        ...
        <section>
          <div className="w-full py-10">
            <div className="w-full max-w-[1070px] mx-auto px-6">
              <h2 className="mb-8 text-center md:text-[32px] font-bold text-[#032b41] text-[24px]">
              ...
              <div className="grid grid-cols-1 gap-10 mb-24 md:grid-cols-3">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="text-2xl text-[#032b41] mb-4 font-medium md:text-[20px]">
                    Read or listen
                  </div>
                  <div className="md:text-lg text-[#394547] font-light text-[14px]">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="md:text-2xl text-[#032b41] mb-4 font-medium text-[20px]">
                    Find your next read
                  </div>
                  <div className="md:text-lg text-[#394547] font-light text-[14px]">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="md:text-2xl text-[#032b41] mb-4 font-mediume text-[20px]">
                    Briefcasts
                  </div>
                  <div className="md:text-lg text-[#394547] font-light text-[14px]">
              ...
              <div className="flex gap-20 mb-24 md:flex-col-2 md:gap-8 md:mb-8">
                <div className="flex w-full md:flex-col justify-center">
                  <div className="mb-4 md:text-[32px] font-medium text-[#6b757b] text-[24px] hover:text-[#20ba68]">
                  ...
                  <div className="md:text-[32px] font-medium text-[#6b757b] text-[24px] hover:text-[#20ba68]">
                ...
                <div className="flex w-full md:flex-col justify-center gap-6 bg-[#f1f6f4] px-6 py-10 md:order-1">
                  <div className="flex gap-4">
                    ...
                    <div className="md:text-xl font-light text-[#394547] text-[16px]">
            ...
            <div className="w-full py-10">
              ...
              <div className="max-w-[600px] mx-auto">
                <div className="bg-[#fff3d7] p-4 mb-8 rounded font-light">
                  ...
                  <div className="text-[#394547] md:text-[16px] tracking-[0.3px] leading-[1.4] text-[14px]">
                ...
                <div className="bg-[#fff3d7] p-4 mb-8 rounded font-light">
                  ...
                  <div className="text-[#394547] tracking-[0.3px] leading-[1.4] md:text-[14px]">
            ...
            <div className="w-full max-w-[1070px] mx-auto px-6">
              ...
              <div className="grid grid-cols-3 gap-10 md:grid-col-1 md:gap-6">
                <div className="flex flex-col items-center rounded-xl bg-[#d7e9ff] p-6 pb-10 text-center">
                  ...
                  <div className="mb-4 md:text-[40px] font-semibold text-[#032b41] text-[32px]">
                    3 Million
                  </div>

                  <div className="font-light text-[#394547] md:text-[14px]">
